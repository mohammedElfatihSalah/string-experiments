...
class BaselineModel2(model.Model):
  ...
  def __init__(
    ...
    super(BaselineModel2, self).__init__(spec=spec)
    ...
    def _use_net(*args, **kwargs):
      return Net2(spec, hidden_dim, encode_hints, decode_hints, decode_diffs,
